...
How to set rules: the Cursor iOS app has no Rules screen. Edit `.cursor/rules/*.mdc` in this repo (or ask the agent to). Optional User Rules are desktop-only (Customize → Rules). See README.
